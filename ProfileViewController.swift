...
class ProfileViewController: UIViewController {
    ...
    func setupInfo() {
        ...
        profileImage.accessibilityLabel = "pfp"
    ...
    func setupContributions() {
        contributionsLabel.text = "No of new additions by you \(UserManager.shared.numberOfContributions ?? 0)"
        ...
        contributionsLabel.accessibilityLabel = ""
    }
